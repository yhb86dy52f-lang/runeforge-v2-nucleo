...
Copy-Item -LiteralPath 'C:\RUNEFOGE_PRO\runeforge\data\audits\termius_key_v2_20260506_023232\administrators_authorized_keys.20260506_023232.bak' -Destination 'C:\ProgramData\ssh\administrators_authorized_keys' -Force
...
Write-Host '[OK] Rollback Termius key V2 aplicado.'
