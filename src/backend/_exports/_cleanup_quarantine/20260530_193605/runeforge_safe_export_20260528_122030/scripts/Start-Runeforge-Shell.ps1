...
# =====================================================================
# RUNEFORGE V43.5 PANEL LAUNCHER
# Comando estable: rf-panel
# =====================================================================
function global:rf-panel {
    $launcher = "C:\RUNEFOGE_PRO\runeforge\scripts\Start-Runeforge-Panel.ps1"
    if (Test-Path -LiteralPath $launcher) {
        pwsh -NoLogo -ExecutionPolicy Bypass -File $launcher
    } else {
        Write-Host "[ERROR] No existe launcher del panel: $launcher" -ForegroundColor Red
    }
}

# =====================================================================
# RUNEFORGE V43.6 ADAPTIVE PANEL COMMANDS
# =====================================================================
function global:rf-mini {
    $launcher = "C:\RUNEFOGE_PRO\runeforge\scripts\Start-Runeforge-Panel.ps1"
    pwsh -NoLogo -ExecutionPolicy Bypass -File $launcher -Mode Quick
}

function global:rf-panel-full {
    $launcher = "C:\RUNEFOGE_PRO\runeforge\scripts\Start-Runeforge-Panel.ps1"
    pwsh -NoLogo -ExecutionPolicy Bypass -File $launcher -Mode Full
}



# >>> RUNEFORGE V43.6.1 PANEL COMMANDS STABLE >>>
# Fecha: 2026-04-24
function global:rf-panel {
    $launcher = "C:\RUNEFOGE_PRO\runeforge\scripts\Start-Runeforge-Panel.ps1"
    if (Test-Path -LiteralPath $launcher) {
...
# RUNEFORGE PROMPT FINAL PERSISTENT
. "C:\RUNEFOGE_PRO\runeforge\scripts\mobile\rf-prompt.ps1"
