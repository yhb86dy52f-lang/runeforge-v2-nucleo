...
## Reglas inmediatas recomendadas
1. No excluir carpetas completas de Defender.
2. No publicar backend en 0.0.0.0 si no es estrictamente necesario.
3. Usar Tailscale para acceso remoto.
4. Guardar secretos solo en .env local y nunca en memoria global.
5. Rotar cualquier token detectado en archivos versionados o memorias.
6. Validar PM2 y servicios antes de abrir UI.
