...
const app = express();
// === RF_LOCAL_AI_SAFE_CURRENT_BEGIN ===
const rfLocalAiRoutesCurrent = require("./modules/local_ai/local_ai.routes");
app.use("/api/ai/local", rfLocalAiRoutesCurrent);
app.use("/forge", express.static(require("path").join(__dirname, "../public/forge")));
app.get("/forge/local-ai.html", function(_req, res) {
  res.sendFile(require("path").join(__dirname, "../public/forge/local-ai.html"));
});
// === RF_LOCAL_AI_SAFE_CURRENT_END ===
